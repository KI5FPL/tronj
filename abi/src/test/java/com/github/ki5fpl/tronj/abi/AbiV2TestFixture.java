...
import com.github.ki5fpl.tronj.abi.datatypes.DynamicStruct;
import com.github.ki5fpl.tronj.abi.datatypes.StaticStruct;
...
public class AbiV2TestFixture {
    ...
    public static class Foo extends DynamicStruct {
        ...
        public Foo(String id, String name) {
            super(
                    new com.github.ki5fpl.tronj.abi.datatypes.Utf8String(id),
                    new com.github.ki5fpl.tronj.abi.datatypes.Utf8String(name));
            this.id = id;
            this.name = name;
        }
    ...
    public static final com.github.ki5fpl.tronj.abi.datatypes.Function setFooFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_SETFOO,
                    Arrays.<Type>asList(new Foo("id", "name")),
                    Collections.<TypeReference<?>>emptyList());

    public static final com.github.ki5fpl.tronj.abi.datatypes.Function getFooFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_GETFOO,
                    Arrays.<Type>asList(),
                    Arrays.<TypeReference<?>>asList(new TypeReference<Foo>() {}));

    public static final com.github.ki5fpl.tronj.abi.datatypes.Function getFooUintFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_GETFOOUINT,
                    Arrays.<Type>asList(),
    ...
    public static class Bar extends StaticStruct {
        ...
        public Bar(BigInteger id, BigInteger data) {
            super(
                    new com.github.ki5fpl.tronj.abi.datatypes.generated.Uint256(id),
                    new com.github.ki5fpl.tronj.abi.datatypes.generated.Uint256(data));
            this.id = id;
            this.data = data;
        }
    ...
    public static final com.github.ki5fpl.tronj.abi.datatypes.Function setBarFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_SETBAR,
                    Arrays.<Type>asList(new Bar(BigInteger.ONE, BigInteger.TEN)),
                    Collections.<TypeReference<?>>emptyList());

    public static final com.github.ki5fpl.tronj.abi.datatypes.Function getBarFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_GETBAR,
                    Arrays.<Type>asList(),
                    Arrays.<TypeReference<?>>asList(new TypeReference<Bar>() {}));

    public static final com.github.ki5fpl.tronj.abi.datatypes.Function getFooBarFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_GETFOOBAR,
                    Arrays.<Type>asList(),
                    Arrays.<TypeReference<?>>asList(
    ...
    public static final com.github.ki5fpl.tronj.abi.datatypes.Function setBazFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_SETBAZ,
    ...
    public static final com.github.ki5fpl.tronj.abi.datatypes.Function setBozFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_SETBOZ,
                    Arrays.<Type>asList(new Boz(BigInteger.ONE, "id")),
                    Collections.<TypeReference<?>>emptyList());

    public static final com.github.ki5fpl.tronj.abi.datatypes.Function getBozFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_SETBOZ,
    ...
    public static class Fuzz extends StaticStruct {
        ...
        public Fuzz(Bar bar, BigInteger data) {
            super(bar, new com.github.ki5fpl.tronj.abi.datatypes.generated.Uint256(data));
            this.bar = bar;
            this.data = data;
        }
    ...
    public static final com.github.ki5fpl.tronj.abi.datatypes.Function setFuzzFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_SETFUZZ,
                    Arrays.<Type>asList(
    ...
    public static final com.github.ki5fpl.tronj.abi.datatypes.Function getFuzzFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_GETFUZZ,
                    Arrays.<Type>asList(),
    ...
    public static final com.github.ki5fpl.tronj.abi.datatypes.Function setNuuFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_SETNUU,
                    Arrays.<Type>asList(new Nuu(new Foo("id", "name"))),
                    Collections.<TypeReference<?>>emptyList());

    public static final com.github.ki5fpl.tronj.abi.datatypes.Function getNuuFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_SETNUU,
                    Collections.<Type>emptyList(),
    ...
    public static class Naz extends DynamicStruct {
        ...
        public Naz(Nar nar, BigInteger data) {
            super(nar, new com.github.ki5fpl.tronj.abi.datatypes.generated.Uint256(data));
            this.nar = nar;
            this.data = data;
        }
    ...
    public static final com.github.ki5fpl.tronj.abi.datatypes.Function setNazFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_SETNAZ,
                    Arrays.<Type>asList(
    ...
    public static final com.github.ki5fpl.tronj.abi.datatypes.Function getNazFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_GETNAZ,
                    Arrays.<Type>asList(),
    ...
    public static class Wiz extends DynamicStruct {
        ...
        public Wiz(Foo foo, String data) {
            super(foo, new com.github.ki5fpl.tronj.abi.datatypes.Utf8String(data));
            this.foo = foo;
            this.data = data;
        }
    ...
    public static final com.github.ki5fpl.tronj.abi.datatypes.Function setWizFunction =
            new com.github.ki5fpl.tronj.abi.datatypes.Function(
                    FUNC_SETWIZ,
